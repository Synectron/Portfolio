  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full px-6 sm:px-12 lg:px-16 pt-6 pb-8 pointer-events-none">
        ...
        <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between w-full pt-4 pb-2 my-auto">
          <motion.div
          ...
          >
            <motion.div variants={fadeUpVariants} className="relative mb-3.5 select-none">
              <h1
                className="text-5xl sm:text-6xl md:text-7xl lg:text-[6.5rem] xl:text-[7.2rem] tracking-tight uppercase leading-[0.88]"
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                {profile.roles[0]} <span className="text-[#8C6D4F] mx-1">•</span>{' '}
                {profile.roles[1]} <span className="text-[#8C6D4F] mx-1">•</span>{' '}
                {profile.roles[2]}
              </p>
            </motion.div>
