        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I&apos;m <span className="text-[#F3DBB3] font-medium">{profile.name}</span>, a {profile.title} specializing in scalable web apps, APIs, and enterprise integrations across BFSI, Energy, and Life Sciences. {profile.summary}
            </motion.p>
            ...
            >
              {stats.map((stat, i) => (
                <div key={stat.label} className="flex flex-col">
                  <span 
                    className={`text-3xl sm:text-4xl font-light tracking-tight ${i % 2 === 1 ? 'text-[#D4AF37]' : 'text-[#F4EBE2]'}`}
                    style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                  >
                    {stat.value}
                  </span>
