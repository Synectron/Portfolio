...
const bentoCategories = [
  {
    title: skillGroups[1].name.toUpperCase(),
    badge: 'CORE PILLAR',
    items: skillGroups[1].skills.slice(0, 5),
    description:
      'Building high-performance React and Angular interfaces, microfrontend ecosystems, and accessible design-system UIs.',
    stat: 'WCAG / ADA',
    colSpan: 'lg:col-span-7',
  },
  {
    title: skillGroups[0].name.toUpperCase(),
    badge: 'ENTERPRISE',
    items: skillGroups[0].skills.slice(0, 5),
    description:
      'REST APIs, OAuth connectors, webhooks, and data orchestration between banking cores, CRMs, and SaaS platforms.',
    stat: 'REAL-TIME SYNC',
    colSpan: 'lg:col-span-5',
  },
  {
    title: skillGroups[2].name.toUpperCase(),
    badge: 'SCALE',
    items: skillGroups[2].skills.slice(0, 5),
    description:
      'AWS-backed microfrontends, monorepos, middleware layers, and loyalty / CRM interconnectivity at enterprise scale.',
    stat: 'CLOUD NATIVE',
    colSpan: 'lg:col-span-5',
  },
  {
    title: skillGroups[3].name.toUpperCase(),
    badge: 'VELOCITY',
    items: skillGroups[3].skills.slice(0, 5),
    description:
      'Jest/Sonar quality gates plus Copilot, Cursor, Claude Code, and MCP agentic workflows to ship faster with confidence.',
    stat: 'AI-ASSISTED',
    colSpan: 'lg:col-span-7',
  },
];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-5xl sm:text-6xl md:text-7xl tracking-tight uppercase leading-[0.88] mb-12"
